    ...
    <div className='service'>
      <div className="service_wrapper">
        ...
        <div className="steps_wrapper">
          <Step title='Konfigurator' color='#68E1BC' text='Loremi ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam.' />
